            ...
            <div className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-8 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
                        ...
                        <div className="flex items-center justify-between px-8 py-4 border border-pink-500 cursor-pointer rounded-xl">
                            <div className="flex flex-col items-center space-y-1">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-pink-600 dark:text-pink-500 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg>
                            ...
                            <div className="flex flex-col items-center space-y-1">
                                <div className="px-2 text-xs text-pink-500 bg-gray-100 rounded-full dark:text-pink-400 sm:px-4 sm:py-1 dark:bg-gray-700 ">
                                    Save 30%
                                </div>

                                <h2 className="text-2xl font-semibold text-pink-600 dark:text-pink-500 sm:text-3xl">$99 <span className="text-base font-medium">/Yearly</span></h2>
                            </div>
                        </div>
                    ...
                    <div className="p-8 mt-8 space-y-8 bg-gray-100 dark:bg-gray-800 rounded-xl">
                        <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-pink-500 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                            </svg>
                        </div>
                    ...
                    <div className="flex justify-center mt-8">
                        <button className="px-8 py-2 tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-600 rounded-md hover:bg-pink-500 focus:outline-none focus:bg-pink-500 focus:ring focus:ring-pink-300 focus:ring-opacity-80">
                            Choose Plan
                        </button>
                    </div>
                </div>
