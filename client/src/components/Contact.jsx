...
const Contact = () => {
    return (
        <>
            ...
            <section className="contact min-h-screen bg-cover ">
                    ...
                    <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
                        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                            <div className="text-white lg:w-1/2 lg:mx-6">
                                ...
                                <button className="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-600 rounded-md hover:bg-pink-500 focus:outline-none focus:ring focus:ring-pink-400 focus:ring-opacity-50">
                                    get in touch
                                </button>
                                ...
                                <div className="mt-6 md:mt-8">
                                    ...
                                    <div className="flex mt-4 -mx-1.5 ">
                                        <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-pink-500" href="#">
                                ...
                                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                                    ...
                                    <form className="mt-6">
                                        <div className="flex-1">
                                            ...
                                            <input type="text" placeholder="John Doe" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-pink-400 focus:ring-pink-300 focus:ring-opacity-40 dark:focus:border-pink-300 focus:outline-none focus:ring" />
                                        </div>
                                        ...
                                        <div className="w-full mt-6">
                                            ...
                                            <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-pink-400 focus:ring-pink-300 focus:ring-opacity-40 dark:focus:border-pink-300 focus:outline-none focus:ring" placeholder="Message"></textarea>
                                        </div>
