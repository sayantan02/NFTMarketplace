                ...
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800 hover:dark:bg-gray-700 hover:cursor-pointer">
                            <span className="inline-block p-3 text-pink-500 bg-pink-100 rounded-full dark:text-white dark:bg-pink-500">
                            ...
                            <a href="#" className="flex items-center -mx-1 text-sm text-pink-500 capitalize transition-colors duration-300 transform dark:text-pink-400 hover:underline hover:text-pink-600 dark:hover:text-pink-500">
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800 hover:dark:bg-gray-700 hover:cursor-pointer">
                            ...
                            <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Zero Configrations</h1>
